...
module.exports = function(cb) {
  ...
  rl.on('close', function() {
    ...
    var presentParticiple = function(v) {
    ...
    var verbConjugate = function(v, tense, negate) {
    ...
    var present = function(v, person, negate) {
      person = person || "";
      negate = negate || false;
    ...
    var past = function(v, person, negate) {
      person = person || "";
      negate = negate || false;
    ...
    var tense = function(v) {
      var infinitive = verbInfinitive(v);
      var a = verbTenses[infinitive];
      
      for (t in verb_tenses_keys) {
        if (a[verb_tenses_keys[t]] == v) {
          return t
        }
        
        if (a[verb_tenses_keys[t]+verb_tenses_keys.length] == v) {
          return t
        }
      }
    }
